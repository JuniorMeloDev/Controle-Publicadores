...
const getServiceYearForMonth = (nomeMes) => {
  ...
  const mesSelecionadoIndex = meses.indexOf(nomeMes);

  // Deduzir o ano real do relatório (Calendário)
  // Se estamos em Janeiro (0) e selecionamos Dezembro (11), assumimos que é Dezembro do ano passado.
  let anoDoRelatorio = anoAtual;
  if (mesSelecionadoIndex > mesAtual) {
    anoDoRelatorio = anoAtual - 1;
  }

  // Calcular Ano de Serviço
  // Regra: Setembro (8) a Dezembro (11) pertencem ao Ano de Serviço seguinte.
  if (mesSelecionadoIndex >= 8) {
    return anoDoRelatorio + 1;
  }

  return anoDoRelatorio;
};
